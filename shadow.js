...
shadow.on('message', (message) => {
      ...
      .setColor("#000000") 
      .setDescription(`
:file_folder:  ${prefix}wt     : واتشنق
:file_folder:  ${prefix}pl     : بلايينق
:file_folder:  ${prefix}li     : استماع
:file_folder:  ${prefix}st     : ستريمنغ
:file_folder:  ${prefix}x      : مسح رسائلك 
:file_folder:  ${prefix}f      : تفكيك
:file_folder:  ${prefix}e      : يرسل الكلام بأيمبد
:file_folder:  ${prefix}av     : يطلع صورتك او صورة اللي تمنشنه
:file_folder:  ${prefix}setav  : تغيير صورتك 
:file_folder:  ${prefix}off    : وضع اوفلاين
:file_folder:  ${prefix}dnd    : وضع عدم الازعاج 
:file_folder:  ${prefix}idle   : وضع خامل
:file_folder:  ${prefix}on     : وضع اونلاين 
 ©Hunndred.`) 
   message.channel.sendEmbed(embed)
          message.delete(3000);   
   }
